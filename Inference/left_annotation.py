...
def parseArgs():
  ...
  parser.add_argument('--db_file', type=str, default ='../DB_Files/testl.db', help= 'DB file location')
  parser.add_argument('--mln_file', type=str, default ='../MLN_Weights/base_rules_left.mln', help= 'MLN Rules file location')
  ...
  for e in range(epochs):
    ...
    if e % 10 == 0:
      ...
      if total_cost == new_cost:
        print("No change in 10 iterations, ending on epoch {}".format(e))
        return fingers
      total_cost = evaluateRules(facts,fingers,weights, distance_matrix, keys)
      print("Cost at iteration {}: {}".format(e,total_cost))
  return fingers
